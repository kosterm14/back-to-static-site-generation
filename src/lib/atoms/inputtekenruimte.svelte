<script>
  ...
  onMount(() => {
    ...
    heenEnWeerButton = document.querySelector('li[aria-label="heen en weer"] button');
  ...
  <main>
    <ul>
      <li aria-label="heen en weer">
        <div class:heen={heen} class:weer={weer}>
          <h3>Kleurenpalet</h3><br>
...
li[aria-label="heen en weer"] div {
	...
	box-shadow:inset 0 0 0 .1em var(--vtDarkBlue);
	color:transparent;
